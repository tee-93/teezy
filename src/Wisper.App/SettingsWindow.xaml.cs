...
{
    private WisperSettings _settings;
    ...
    public event Action<WisperSettings>? SettingsChanged;

    public SettingsWindow(WisperSettings settings, ParakeetTranscriber? transcriber, bool modelReady)
    {
        InitializeComponent();
        _settings = settings;
